...
# Calculate precision-recall curves (oM).
PR_AutoScore_oM <- pr.curve(scores.class0 = test_set_oM$"AutoScore Score", weights.class0 = test_set_oM$label, curve=TRUE)
PR_CRASH_oM <- pr.curve(scores.class0 = test_set_oM$"CRASH Score", weights.class0 = test_set_oM$label, curve=TRUE)
PR_IMPACT_oM <- pr.curve(scores.class0 = test_set_oM$"IMPACT Score", weights.class0 = test_set_oM$label, curve=TRUE)
...
auprc_AutoScore_oM <- unname(ci.auc(PR_AutoScore_oM, conf.level=0.95)[c(2, 1, 3)])
auprc_AutoScore_oM <- sprintf("%.3f (%.3f - %.3f)", PR_AutoScore_oM[1], PR_AutoScore_oM[2], PR_AutoScore_oM[3])
...
#Plot PR Curves (oM).
pdf("Figures/PRCs (Overall Mortality).pdf", width = 9, height = 9)
par(font.lab=2, xaxs = "i", yaxs = "i", cex.axis=1.5, cex.lab=1.5)
plot(1, type = "n", xlab = "Recall", ylab = "Precision", xlim = c(0,1), ylim = c(0,1))
lines(PR_AutoScore_oM$curve, col = rgb(red=0, green=0, blue=1, alpha=0.8), lwd=4.0)
lines(PR_CRASH_oM$curve, col = rgb(red=1, green=0, blue=0, alpha=0.8), lwd=4.0)
lines(PR_IMPACT_oM$curve, col = rgb(red=0, green=1, blue=0, alpha=0.8), lwd=4.0)
legend(x = 0.47, y = 0.910, paste("The MOST AUPRC =", sprintf("%.3f", PR_AutoScore_oM$auc.integral)), col = "blue", lwd=4.0, bty = "n", cex=1.5, text.font=1)
legend(x = 0.47, y = 1.000, paste("CRASH AUPRC =", sprintf("%.3f", PR_CRASH_oM$auc.integral)), col = "red", lwd=4.0, bty = "n", cex=1.5, text.font=1)
legend(x = 0.47, y = 0.955, paste("IMPACT AUPRC =", sprintf("%.3f", PR_IMPACT_oM$auc.integral)), col = "green", lwd=4.0, bty = "n", cex=1.5, text.font=1)
dev.off()
...
# Calculate precision-recall curves (threedM)
PR_AutoScore_threedM <- pr.curve(scores.class0 = test_set_threedM$"AutoScore Score", weights.class0 = test_set_threedM$label, curve=TRUE)
PR_CRASH_threedM <- pr.curve(scores.class0 = test_set_threedM$"CRASH Score", weights.class0 = test_set_threedM$label, curve=TRUE)
PR_IMPACT_threedM <- pr.curve(scores.class0 = test_set_threedM$"IMPACT Score", weights.class0 = test_set_threedM$label, curve=TRUE)
...
#Plot PR Curves (threedM).
pdf("Figures/PRCs (3-Day Mortality).pdf", width = 9, height = 9)
par(font.lab=2, xaxs = "i", yaxs = "i", cex.axis=1.5, cex.lab=1.5)
plot(1, type = "n", xlab = "Recall", ylab = "Precision", xlim = c(0,1), ylim = c(0,1))
lines(PR_AutoScore_threedM$curve, col = rgb(red=0, green=0, blue=1, alpha=0.8), lwd=4.0)
lines(PR_CRASH_threedM$curve, col = rgb(red=1, green=0, blue=0, alpha=0.8), lwd=4.0)
lines(PR_IMPACT_threedM$curve, col = rgb(red=0, green=1, blue=0, alpha=0.8), lwd=4.0)
legend(x = 0.47, y = 0.910, paste("The MOST AUPRC =", sprintf("%.3f", PR_AutoScore_threedM$auc.integral)), col = "blue", lwd=4.0, bty = "n", cex=1.5, text.font=1)
legend(x = 0.47, y = 1.000, paste("CRASH AUPRC =", sprintf("%.3f", PR_CRASH_threedM$auc.integral)), col = "red", lwd=4.0, bty = "n", cex=1.5, text.font=1)
legend(x = 0.47, y = 0.955, paste("IMPACT AUPRC =", sprintf("%.3f", PR_IMPACT_threedM$auc.integral)), col = "green", lwd=4.0, bty = "n", cex=1.5, text.font=1)
dev.off()
...
# Calculate precision-recall curves (sevendM).
PR_AutoScore_sevendM <- pr.curve(scores.class0 = test_set_sevendM$"AutoScore Score", weights.class0 = test_set_sevendM$label, curve=TRUE)
PR_CRASH_sevendM <- pr.curve(scores.class0 = test_set_sevendM$"CRASH Score", weights.class0 = test_set_sevendM$label, curve=TRUE)
PR_IMPACT_sevendM <- pr.curve(scores.class0 = test_set_sevendM$"IMPACT Score", weights.class0 = test_set_sevendM$label, curve=TRUE)
...
#Plot PR Curves (sevendM).
pdf("Figures/PRCs (7-Day Mortality).pdf", width = 9, height = 9)
par(font.lab=2, xaxs = "i", yaxs = "i", cex.axis=1.5, cex.lab=1.5)
plot(1, type = "n", xlab = "Recall", ylab = "Precision", xlim = c(0,1), ylim = c(0,1))
lines(PR_AutoScore_sevendM$curve, col = rgb(red=0, green=0, blue=1, alpha=0.8), lwd=4.0)
lines(PR_CRASH_sevendM$curve, col = rgb(red=1, green=0, blue=0, alpha=0.8), lwd=4.0)
lines(PR_IMPACT_sevendM$curve, col = rgb(red=0, green=1, blue=0, alpha=0.8), lwd=4.0)
legend(x = 0.47, y = 0.910, paste("The MOST AUPRC =", sprintf("%.3f", PR_AutoScore_sevendM$auc.integral)), col = "blue", lwd=4.0, bty = "n", cex=1.5, text.font=1)
legend(x = 0.47, y = 1.000, paste("CRASH AUPRC =", sprintf("%.3f", PR_CRASH_sevendM$auc.integral)), col = "red", lwd=4.0, bty = "n", cex=1.5, text.font=1)
legend(x = 0.47, y = 0.955, paste("IMPACT AUPRC =", sprintf("%.3f", PR_IMPACT_sevendM$auc.integral)), col = "green", lwd=4.0, bty = "n", cex=1.5, text.font=1)
dev.off()
...
# Calculate precision-recall curves (fourteendM).
PR_AutoScore_fourteendM <- pr.curve(scores.class0 = test_set_fourteendM$"AutoScore Score", weights.class0 = test_set_fourteendM$label, curve=TRUE)
PR_CRASH_fourteendM <- pr.curve(scores.class0 = test_set_fourteendM$"CRASH Score", weights.class0 = test_set_fourteendM$label, curve=TRUE)
PR_IMPACT_fourteendM <- pr.curve(scores.class0 = test_set_fourteendM$"IMPACT Score", weights.class0 = test_set_fourteendM$label, curve=TRUE)
...
#Plot PR Curves (fourteendM).
pdf("Figures/PRCs (14-Day Mortality).pdf", width = 9, height = 9)
par(font.lab=2, xaxs = "i", yaxs = "i", cex.axis=1.5, cex.lab=1.5)
plot(1, type = "n", xlab = "Recall", ylab = "Precision", xlim = c(0,1), ylim = c(0,1))
lines(PR_AutoScore_fourteendM$curve, col = rgb(red=0, green=0, blue=1, alpha=0.8), lwd=4.0)
lines(PR_CRASH_fourteendM$curve, col = rgb(red=1, green=0, blue=0, alpha=0.8), lwd=4.0)
lines(PR_IMPACT_fourteendM$curve, col = rgb(red=0, green=1, blue=0, alpha=0.8), lwd=4.0)
legend(x = 0.47, y = 0.910, paste("The MOST AUPRC =", sprintf("%.3f", PR_AutoScore_fourteendM$auc.integral)), col = "blue", lwd=4.0, bty = "n", cex=1.5, text.font=1)
legend(x = 0.47, y = 1.000, paste("CRASH AUPRC =", sprintf("%.3f", PR_CRASH_fourteendM$auc.integral)), col = "red", lwd=4.0, bty = "n", cex=1.5, text.font=1)
legend(x = 0.47, y = 0.955, paste("IMPACT AUPRC =", sprintf("%.3f", PR_IMPACT_fourteendM$auc.integral)), col = "green", lwd=4.0, bty = "n", cex=1.5, text.font=1)
dev.off()
...
#Plot PR Curves (thirtydM).
pdf("Figures/PRCs (30-Day Mortality).pdf", width = 9, height = 9)
par(font.lab=2, xaxs = "i", yaxs = "i", cex.axis=1.5, cex.lab=1.5)
plot(1, type = "n", xlab = "Recall", ylab = "Precision", xlim = c(0,1), ylim = c(0,1))
lines(PR_AutoScore_thirtydM$curve, col = rgb(red=0, green=0, blue=1, alpha=0.8), lwd=4.0)
lines(PR_CRASH_thirtydM$curve, col = rgb(red=1, green=0, blue=0, alpha=0.8), lwd=4.0)
lines(PR_IMPACT_thirtydM$curve, col = rgb(red=0, green=1, blue=0, alpha=0.8), lwd=4.0)
legend(x = 0.47, y = 0.910, paste("The MOST AUPRC =", sprintf("%.3f", PR_AutoScore_thirtydM$auc.integral)), col = "blue", lwd=4.0, bty = "n", cex=1.5, text.font=1)
legend(x = 0.47, y = 1.000, paste("CRASH AUPRC =", sprintf("%.3f", PR_CRASH_thirtydM$auc.integral)), col = "red", lwd=4.0, bty = "n", cex=1.5, text.font=1)
legend(x = 0.47, y = 0.955, paste("IMPACT AUPRC =", sprintf("%.3f", PR_IMPACT_thirtydM$auc.integral)), col = "green", lwd=4.0, bty = "n", cex=1.5, text.font=1)
dev.off()
...
ggsave(filename = "Figures/Calibration Plot (Overall Mortality - AutoScore).pdf", plot = cc_CRASH_oM$calibration_plot, width = 5, height = 5, dpi = 300)
...
ggsave(filename = "Figures/Calibration Plot (Overall Mortality - AutoScore).pdf", plot = cc_IMPACT_oM$calibration_plot, width = 5, height = 5, dpi = 300)
...
ggsave(filename = "Figures/Calibration Plot (3-Day Mortality - AutoScore).pdf", plot = cc_IMPACT_threedM$calibration_plot, width = 5, height = 5, dpi = 300)
...
ggsave(filename = "Figures/Calibration Plot (7-Day Mortality - AutoScore).pdf", plot = cc_CRASH_sevendM$calibration_plot, width = 5, height = 5, dpi = 300)
...
ggsave(filename = "Figures/Calibration Plot (7-Day Mortality - AutoScore).pdf", plot = cc_IMPACT_sevendM$calibration_plot, width = 5, height = 5, dpi = 300)
...
ggsave(filename = "Figures/Calibration Plot (14-Day Mortality - AutoScore).pdf", plot = cc_CRASH_fourteendM$calibration_plot, width = 5, height = 5, dpi = 300)
...
ggsave(filename = "Figures/Calibration Plot (14-Day Mortality - AutoScore).pdf", plot = cc_IMPACT_fourteendM$calibration_plot, width = 5, height = 5, dpi = 300)
...
ggsave(filename = "Figures/Calibration Plot (30-Day Mortality - AutoScore).pdf", plot = cc_CRASH_thirtydM$calibration_plot, width = 5, height = 5, dpi = 300)
...
ggsave(filename = "Figures/Calibration Plot (30-Day Mortality - AutoScore).pdf", plot = cc_IMPACT_thirtydM $calibration_plot, width = 5, height = 5, dpi = 300)
...
# Calculate precision-recall curves for sensitivity analysis (CRASH).
PR_AutoScore_sa_CRASH <- pr.curve(scores.class0 = test_set_sa_CRASH$"AutoScore Score", weights.class0 = test_set_sa_CRASH$label, curve=TRUE)
PR_CRASH_sa_CRASH <- pr.curve(scores.class0 = test_set_sa_CRASH$"CRASH Score", weights.class0 = test_set_sa_CRASH$label, curve=TRUE)
...
auprc_AutoScore_sa_CRASH <- unname(ci.auc(PR_AutoScore_sa_CRASH, conf.level=0.95)[c(2, 1, 3)])
auprc_AutoScore_sa_CRASH <- sprintf("%.3f (%.3f - %.3f)", PR_AutoScore_sa_CRASH[1], PR_AutoScore_sa_CRASH[2], PR_AutoScore_sa_CRASH[3])
...
#Plot PR Curves for sensitivity analysis (CRASH).
pdf("Figures/PRCs (Sensitivity Analysis - CRASH).pdf", width = 9, height = 9)
par(font.lab=2, xaxs = "i", yaxs = "i", cex.axis=1.5, cex.lab=1.5)
plot(1, type = "n", xlab = "Recall", ylab = "Precision", xlim = c(0,1), ylim = c(0,1))
lines(PR_AutoScore_sa_CRASH$curve, col = rgb(red=0, green=0, blue=1, alpha=0.8), lwd=4.0)
lines(PR_CRASH_sa_CRASH$curve, col = rgb(red=1, green=0, blue=0, alpha=0.8), lwd=4.0)
legend(x = 0.47, y = 0.910, paste("The MOST AUPRC =", sprintf("%.3f", PR_AutoScore_sa_CRASH$auc.integral)), col = "blue", lwd=4.0, bty = "n", cex=1.5, text.font=1)
legend(x = 0.47, y = 0.955, paste("CRASH AUPRC =", sprintf("%.3f", PR_CRASH_sa_CRASH$auc.integral)), col = "red", lwd=4.0, bty = "n", cex=1.5, text.font=1)
dev.off()
...
check_data(test_data_sa_IMPACT)
...
# Calculate precision-recall curves for sensitivity analysis (IMPACT).
PR_AutoScore_sa_IMPACT <- pr.curve(scores.class0 = test_set_sa_IMPACT$"AutoScore Score", weights.class0 = test_set_sa_IMPACT$label, curve=TRUE)
PR_IMPACT_sa_IMPACT <- pr.curve(scores.class0 = test_set_sa_IMPACT$"IMPACT Score", weights.class0 = test_set_sa_IMPACT$label, curve=TRUE)
...
auprc_AutoScore_sa_IMPACT <- unname(ci.auc(PR_AutoScore_sa_IMPACT, conf.level=0.95)[c(2, 1, 3)])
auprc_AutoScore_sa_IMPACT <- sprintf("%.3f (%.3f - %.3f)", PR_AutoScore_sa_IMPACT[1], PR_AutoScore_sa_IMPACT[2], PR_AutoScore_sa_IMPACT[3])
...
#Plot PR Curves for sensitivity analysis (IMPACT).
pdf("Figures/PRCs (Sensitivity Analysis - IMPACT).pdf", width = 9, height = 9)
par(font.lab=2, xaxs = "i", yaxs = "i", cex.axis=1.5, cex.lab=1.5)
plot(1, type = "n", xlab = "Recall", ylab = "Precision", xlim = c(0,1), ylim = c(0,1))
lines(PR_AutoScore_sa_IMPACT$curve, col = rgb(red=0, green=0, blue=1, alpha=0.8), lwd=4.0)
lines(PR_IMPACT_sa_IMPACT$curve, col = rgb(red=0, green=1, blue=0, alpha=0.8), lwd=4.0)
legend(x = 0.47, y = 0.910, paste("The MOST AUPRC =", sprintf("%.3f", PR_AutoScore_sa_IMPACT$auc.integral)), col = "blue", lwd=4.0, bty = "n", cex=1.5, text.font=1)
legend(x = 0.47, y = 0.955, paste("IMPACT AUPRC =", sprintf("%.3f", PR_IMPACT_sa_IMPACT$auc.integral)), col = "green", lwd=4.0, bty = "n", cex=1.5, text.font=1)
dev.off()
